...
const fetchModelSchema = async (className) => {
  if (typeof className === "string") {
    return (await fetch("../node_modules/@meveo-org/mv-form/model/" + className + ".json")).json();
  } else {
    return className;
  }
};
...
const fetchModelSchemaSync = (className) => {
  if (typeof className === "string") {
    ...
    request.open("GET", "../node_modules/@meveo-org/mv-form/model/" + className + ".json", false); // `false` makes the request synchronous
    request.send(null);
